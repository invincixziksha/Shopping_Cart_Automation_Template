...
import pages.Money_Control_L1_Pages;
import pages.StartupPage;
import testBase.AppTestBase;

public class Money_Control_L1_TestCases extends AppTestBase
{
	Map<String, String> configData;
	Map<String, String> loginCredentials;
	String expectedDataFilePath = testDataFilePath+"expected_data.json";
	StartupPage startupPage;
	Money_Control_L1_Pages L1PageClass;
	...
	public void initBrowser(String browser, String environment) throws Exception {
		...
		public void verifyNavigateToHomePage() throws Exception {
			...
			L1PageClass= new Money_Control_L1_Pages(driver);
...
//			yakshaAssert(currentTest(), false, businessTestFile);
			...
			public void click_Shop_Menu() throws Exception {
				...
				Money_Control_L1_Pages page=L1PageClass.ClickOnShop();
			...
			public void click_on_cart() throws Exception {
				...
				Money_Control_L1_Pages page=L1PageClass.click_on_cart_icon();
			...
			public void Click_on_Home() throws Exception {
				try
				{
					...
					Money_Control_L1_Pages page=L1PageClass.click_on_Home_Menu();
			...
			public void navigateToHomePage() throws Exception {
				...
				public void one_product_isClickable() throws Exception {
					try
					{
						...
						Money_Control_L1_Pages page=L1PageClass.click_on_seleniumRuby_Product();
				...
				public void add_to_basket() throws Exception {
					try
					{
						...
						Money_Control_L1_Pages page=L1PageClass.Add_to_basket_is_present();
				...
				public void Click_on_add_to_basket() throws Exception {
					try
					{
						...
						Money_Control_L1_Pages page=L1PageClass.ClickonAddToBasket();
				...
				public void GoToCart() throws Exception {
					try
					{
						softAssert = new SoftAssert();
						L1PageClass= new Money_Control_L1_Pages(driver);
						Money_Control_L1_Pages page=L1PageClass.go_to_cart();
				...
				public void Apply_Coupon() throws Exception {
					try
					{
						softAssert = new SoftAssert();
						L1PageClass= new Money_Control_L1_Pages(driver);
						 Money_Control_L1_Pages page=L1PageClass.applyCouponIsPresent();
				...
				public void remove_option_is_present() throws Exception {
					try
					{
						softAssert = new SoftAssert();
						L1PageClass= new Money_Control_L1_Pages(driver);
						Money_Control_L1_Pages page=L1PageClass.removeIsPresent();
				...
				public void remove() throws Exception {
					try
					{
						softAssert = new SoftAssert();
						L1PageClass= new Money_Control_L1_Pages(driver);
						Money_Control_L1_Pages page=L1PageClass.removeAproduct();
				...
				public void Update_Basket() throws Exception {
					try
					{
						...
						Money_Control_L1_Pages page=L1PageClass.updateBasketButton();
				...
				public void Proceed_to_checkout() throws Exception {
					try
					{
						...
						Money_Control_L1_Pages page=L1PageClass.Proceedtocheckout();
				...
				public void Click_Proceed_to_checkout() throws Exception {
					try
					{
						...
						Money_Control_L1_Pages page=L1PageClass.clickOnProceedtocheckout();
